...
def run_yolo_detection_and_ocr():
    ...
    for attr in ['detected_plate_label', 'cropped_plate_label', 'thresh_label', 'contour_label', 'corner_label', 'warped_label', 'deskewed_label', 'blurred_final_label', 'detected_chars_label']:
    ...
    # 3. Postprocess: Grayscale -> Threshold
    filename_label.config(text="Step 3/6: Grayscale and Thresholding...", fg=TEXT_COLOR)
    root.update_idletasks()
    ...
    if not hasattr(root, 'thresh_label'):
        frame = tk.Frame(image_frame, bg=FRAME_BG_COLOR, bd=2, relief="solid")
        frame.pack(side=tk.LEFT, padx=10, pady=10)
        tk.Label(frame, text="3. Grayscale + Threshold", font=FONT_SUB_TITLE, bg=FRAME_BG_COLOR, fg=HEADER_COLOR).pack(pady=5)
    ...
    # 4. Contour Detection
    filename_label.config(text="Step 4/7: Contour Detection...", fg=TEXT_COLOR)
    root.update_idletasks()
    ...
    if not hasattr(root, 'contour_label'):
        frame = tk.Frame(image_frame, bg=FRAME_BG_COLOR, bd=2, relief="solid")
        frame.pack(side=tk.LEFT, padx=10, pady=10)
        tk.Label(frame, text="4. Contour Detection", font=FONT_SUB_TITLE, bg=FRAME_BG_COLOR, fg=HEADER_COLOR).pack(pady=5)
    ...
    # 5. Rectangle Corner Detection
    filename_label.config(text="Step 5/8: Rectangle Corner Detection...", fg=TEXT_COLOR)
    root.update_idletasks()
    ...
    if not hasattr(root, 'corner_label'):
        frame = tk.Frame(image_frame, bg=FRAME_BG_COLOR, bd=2, relief="solid")
        frame.pack(side=tk.LEFT, padx=10, pady=10)
        tk.Label(frame, text="5. Rectangle Corners", font=FONT_SUB_TITLE, bg=FRAME_BG_COLOR, fg=HEADER_COLOR).pack(pady=5)
    ...
    # 6. Warp Perspective
    filename_label.config(text="Step 6/9: Warp Perspective...", fg=TEXT_COLOR)
    root.update_idletasks()
    ...
    if not hasattr(root, 'warped_label'):
        frame = tk.Frame(image_frame, bg=FRAME_BG_COLOR, bd=2, relief="solid")
        frame.pack(side=tk.LEFT, padx=10, pady=10)
        tk.Label(frame, text="6. Warped Perspective", font=FONT_SUB_TITLE, bg=FRAME_BG_COLOR, fg=HEADER_COLOR).pack(pady=5)
    ...
    # 7. Deskew
    filename_label.config(text="Step 7/9: Deskewing plate...", fg=TEXT_COLOR)
    root.update_idletasks()
    ...
    if not hasattr(root, 'deskewed_label'):
        frame = tk.Frame(image_frame, bg=FRAME_BG_COLOR, bd=2, relief="solid")
        frame.pack(side=tk.LEFT, padx=10, pady=10)
        tk.Label(frame, text="7. Deskewed Plate", font=FONT_SUB_TITLE, bg=FRAME_BG_COLOR, fg=HEADER_COLOR).pack(pady=5)
    ...
    # 8. Blur the deskewed image for OCR
    filename_label.config(text="Step 8/9: Blurring final image for OCR...", fg=TEXT_COLOR)
    root.update_idletasks()
    ...
    if not hasattr(root, 'blurred_final_label'):
        frame = tk.Frame(image_frame, bg=FRAME_BG_COLOR, bd=2, relief="solid")
        frame.pack(side=tk.LEFT, padx=10, pady=10)
        tk.Label(frame, text="8. Final Blurred Plate", font=FONT_SUB_TITLE, bg=FRAME_BG_COLOR, fg=HEADER_COLOR).pack(pady=5)
    ...
    # 9. OCR: Tesseract
    filename_label.config(text="Step 9/9: OCR and cleaning text...", fg=TEXT_COLOR)
    root.update_idletasks()
    ...
    if not hasattr(root, 'detected_chars_label'):
        frame = tk.Frame(image_frame, bg=FRAME_BG_COLOR, bd=2, relief="solid")
        frame.pack(side=tk.LEFT, padx=10, pady=10)
        tk.Label(frame, text="9. Chars Detected", font=FONT_SUB_TITLE, bg=FRAME_BG_COLOR, fg=HEADER_COLOR).pack(pady=5)
